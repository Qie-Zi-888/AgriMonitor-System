...
#define CONFIG_WIFI_SSID          "ljw"                                        //修改为自己的WiFi 热点账号
#define CONFIG_WIFI_PWD           "520131466"                                  //修改为自己的WiFi 热点密码

#define CONFIG_APP_SERVERIP       "117.78.5.125"                               //华为IoT平台IP
#define CONFIG_APP_SERVERPORT     "1883"                                        //华为IoT平台端口

#define CONFIG_APP_DEVICEID       "6847e06232771f177b40a32d_senser"         //替换为注册设备后生成的deviceid
#define CONFIG_APP_DEVICEPWD      "f2e6fac277252908f1b576d336744cbb"                                   //替换为注册设备后生成的密钥
